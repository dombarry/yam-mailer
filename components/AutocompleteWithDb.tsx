...
import type { AcProps, Data, MaybeData } from "@/lib/types"
...
// Update the useData function to properly handle the roster data
const useData = (apiRoute: string): MaybeData => {
  ...
  if (data === undefined)
    return {
      records: null,
      isLoading,
      isError: new Error("No data... if this is a mistake, please contact the facilities manager"),
    }
