...
import type { DayData, Granularity, Hall, HallStats, Month, MonthData, WeekData } from "@/lib/types"
            ...
            <ResponsiveContainer width="100%" height={350}>
              <BarChart data={dataByGranularity(data, granularity, totalHandler, true)}>
                ...
                {props.halls.map((hall, key) => {
                  return <Bar dataKey={hall} key={key} fill={colorMap(hall)} radius={[4, 4, 0, 0]} stackId="stack" />
                })}
            ...
            <ResponsiveContainer width="100%" height={350}>
              ...
              >
                <defs>
                  {props.halls.map((hall, key) => {
                    return (
                      <linearGradient id={`color${hall}`} x1="0" y1="0" x2="0" y2="1" key={key}>
